...
#define CONFIG_USBHOST_PSC_PRIO 1
#endif
...
#define USBD_IRQHandler otg_fs_isr
#define CONFIG_USB_DWC2_PORT FS_PORT
// not sure whether we do or not, but sounds good!
#define CONFIG_DWC2_VBUS_SENSING 1
//#define CONFIG_USBHOST_PSC_PRIO (tskIDLE_PRIORITY + 1)
// These threee are in the demo usb_host.c				    
